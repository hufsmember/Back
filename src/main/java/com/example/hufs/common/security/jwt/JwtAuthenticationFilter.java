...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String accessToken = request.getHeader("accessToken"); //header의 AUTHORIZATION 필드를 읽어옴.(해당 필드에는 토큰 값이 있음)
        if (accessToken!=null&&tokenManager.isTokenBlacklisted(accessToken)){
